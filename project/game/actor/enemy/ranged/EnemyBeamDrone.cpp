...
void EnemyBeamDrone::Update(float deltaTime) {
    ...
    UpdateEnemyTimers(deltaTime);
    UpdateEnemyMovement(deltaTime);
    UpdateEnemyBeamState(deltaTime);
    BaseEnemy::Update(deltaTime);
}

bool EnemyBeamDrone::UpdateInactiveState(float deltaTime) {
...
void EnemyBeamDrone::UpdateEnemyTimers(float deltaTime) {
    CaptureHomePosition();
    hoverTimer_ += deltaTime;
    cooldownTimer_ = (std::max)(0.0f, cooldownTimer_ - deltaTime);
}

void EnemyBeamDrone::UpdateEnemyMovement(float deltaTime) {
...
void EnemyBeamDrone::UpdateEnemyBeamState(float deltaTime) {
