...
private:
	...
	Vector3 bodyStartRot_{};
	Vector3 headStartRot_{};
	Vector3 rightArmStartRot_{};
	Vector3 leftArmStartRot_{};
	Vector3 rightFootStartRot_{};
